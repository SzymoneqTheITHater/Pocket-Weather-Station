...
android {
    namespace = "com.example.pocket_weather_station_app"
...
dependencies {
    // Backport of java.time etc. for older Android, required by
    // flutter_local_notifications when desugaring is enabled.
